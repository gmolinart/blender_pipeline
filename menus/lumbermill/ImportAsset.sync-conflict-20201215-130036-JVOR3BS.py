...
def get_asset_from_name(keys=''):
    ...
    default_asset = path_object.latest_version(publish_= True)
...
class ImportAsset(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        lm.import_file(get_asset_from_name(self.my_enum).path_root, snap_to_cursor = True)
        return {'FINISHED'}
