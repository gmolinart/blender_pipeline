...
class Navigation(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        self.layout.row().operator("object.copy__to__variant")
        self.layout.row().operator("object.copy_to_task")
        self.layout.row().operator("object.new__variant")
        self.layout.row().operator("object.switch_variant")
        self.layout.row().operator("object.export_file")
        self.layout.row().operator("object.new_resolution")
